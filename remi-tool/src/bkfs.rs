    ...
    > {
        ...
        async move {
            ...
            Ok(ToolResult::Output(stream! {
                yield ToolOutput::Result(content);
            }))
        }
    }
}
...
impl Tool for FsWriteTool {
    ...
    > {
        ...
        async move {
            ...
            Ok(ToolResult::Output(stream! {
                yield ToolOutput::Result(format!("wrote {} bytes to {}", bytes, path_str));
            }))
        }
    }
}
...
impl Tool for FsCreateTool {
    ...
    > {
        ...
        async move {
            ...
            Ok(ToolResult::Output(stream! {
                yield ToolOutput::Result(format!("created directory {}", path_str));
            }))
        }
    }
}
...
impl Tool for FsRemoveTool {
    ...
    > {
        ...
        async move {
            ...
            Ok(ToolResult::Output(stream! {
                yield ToolOutput::Result(format!("removed {}", path_str));
            }))
        }
    }
}
...
impl Tool for FsLsTool {
    ...
    > {
        ...
        async move {
            ...
            Ok(ToolResult::Output(stream! {
                yield ToolOutput::Result(json.to_string());
            }))
        }
    }
}
